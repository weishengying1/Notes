...
benchmark = MMLU(n_shots=0,tasks=[MMLUTask.MORAL_SCENARIOS, MMLUTask.MORAL_DISPUTES, MMLUTask.ELECTRICAL_ENGINEERING, MMLUTask.ASTRONOMY, MMLUTask.COLLEGE_BIOLOGY],)
